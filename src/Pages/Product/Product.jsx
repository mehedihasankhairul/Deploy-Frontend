      ...
      <div className='container'>
        <div className='row mt-3'>
          ...
          <div className='col-md-6 pd-content'>
            <h2>{item.productName} {productid} </h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos quos possimus aliquam ipsam vitae! Temporibus!</p>
            <h5>Product Price</h5>
            <h2>BDT 250</h2>
            <form>
              <label>Quantity:</label>
              <input type='number' id='input1' step='1' min='1' max='999' size='4' pattern='[0-9]*' />
