                        ...
                        <ul className="navbar-nav mr-auto">
                            <form className="navbar-form navbar-left p-2 pt-4" role="search">
                                ...
                                <div className="form-group d-flex">
                                    <input type="text" className="form-control search-top px-5 me-3" placeholder="Search Product" name="search_text" />
                                    <input className="btn btn-success mx-2" type="button" placeholder="Search Products" value="Search" />
                                </div>
                            </form>
                        </ul>
